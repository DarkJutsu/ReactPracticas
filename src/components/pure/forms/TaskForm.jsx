	...
	return (
        ...
        <div className='grid grid-cols-2'>
          <div>
            ...
            <input ref={nameRef} id='inpName' type='text' required autoFocus
          ...
          <div>
            <label className='text-zinc-700' htmlFor='selectLvl'>Priority</label>
            <select ref={levelRef} id='selectLvl' defaultValue={LEVELS.NORMAL} 
          ...
          <div>
            <label className='text-zinc-700 mt-3 xl:mt-0'>Description Task</label>
            <textarea ref={descripRef} id='inpName' type='text' required
              className='mt-0 block w-96 px-2 bg-zinc-200 border-b-2 border-t-0 border-x-0 border-zinc-400 focus:ring-0 focus:border-zinc-800'
            />
          </div>

        </div>
        <button type='submit' className='bg-zinc-500 text-lime-100 mt-5 py-2 px-3 rounded-md hover:shadow-xl hover:bg-zinc-600'>Add</button>
      </form>
		</div>
	);
};
